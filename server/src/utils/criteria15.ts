...
export const CRITERIA_15_DEFINITIONS: CriterionDefinition[] = [
  // TIER BIRU (1 - 3)
  {
    ...
    indikator_bukti: 'SK Penetapan KUPS oleh Kepala Balai PSKL / SK Pembentukan Kelompok Usaha',
    gap_percentage: 0,
  ...
  // TIER PLATINUM (Verifikasi Khusus Lapangan)
  {
    ...
    indikator_bukti: 'Sertifikat KUPS Platinum bertanda tangan Dirjen PSKL & dokumen PEB/invoice ekspor',
    gap_percentage: 98,
